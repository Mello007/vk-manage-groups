...
public class OauthVkController {
    ...
    public void sendLink(HttpServletResponse response) throws IOException{
        response.sendRedirect("https://oauth.vk.com/authorize?client_id=5499487&display=page&scope=groups,messages,photos,docs&redirect_uri=http://botsell.ru/oauth/token&scope=offline&response_type=code&v=5.52");
    }
    ...
    public void getToken(@RequestParam String code, HttpServletResponse response) throws Exception {
        ...
        response.sendRedirect("http://botsell.ru/api-1.0-SNAPSHOT/admin.html");
    }
}
