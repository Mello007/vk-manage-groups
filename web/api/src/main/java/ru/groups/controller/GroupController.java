...
public class GroupController {
    ...
    public String getAccessKeyOfGroups(@RequestParam String groupId) throws Exception{
        String reqUrl = "https://oauth.vk.com/authorize?client_id=5499487&redirect_uri=http://89.223.28.35:8080/api-1.0-SNAPSHOT/getaccess&group_id={group_id}&scope=manage,messages,photos,docs&display=page&response_type=code&v={version}"
